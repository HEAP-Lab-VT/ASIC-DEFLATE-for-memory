package lz77AndHuffmanCompressor
...
class lz77AndHuffmanCompressor(lz77Params: lz77Parameters, huffmanParams: huffmanParameters) extends Module {
...
object lz77AndHuffmanCompressor extends App {
  ...
  chisel3.Driver
    .execute(Array[String](), () => new lz77AndHuffmanCompressor(lz77Config, huffmanConfig))
}
